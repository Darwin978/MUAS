   ...
   //ELIMINAR DE LA TABLA-BASE
    ...
    KeyListener knj = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
               ...
               if (((nom_jur < 'a' | nom_jur > 'z') & (nom_jur < 'A' | nom_jur > 'Z') & (nom_jur != KeyEvent.VK_SPACE)) | (vista.getTxtnombres().getText().length() >= 50)) {
                    ke.consume();
                }
    ...
    KeyListener kaj = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
               ...
               if (((ape_jur < 'a' | ape_jur > 'z') & (ape_jur < 'A' | ape_jur > 'Z') & (ape_jur != KeyEvent.VK_SPACE)) | (vista.getTxtapellidos().getText().length() >= 50)) {
                    ke.consume();
                }
    ...
    KeyListener krsj = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
               ...
               if (((razon < 'a' | razon > 'z') & (razon < 'A' | razon > 'Z') & (razon != KeyEvent.VK_SPACE)) | (vista.getTxtrazon().getText().length() >= 150)) {
                    ke.consume();
                }
