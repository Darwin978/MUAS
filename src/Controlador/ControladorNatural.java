...
//            vista.getDialogo_Natural().setLocationRelativeTo(null);
    ...
    KeyListener knn = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
               ...
               if (((Nombres < 'a' | Nombres > 'z') & (Nombres < 'A' | Nombres > 'Z') & (Nombres != KeyEvent.VK_SPACE)) | (vista.getTxtNombres().getText().length() >= 50)) {
                    ke.consume();
                }
    ...
    KeyListener kan = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
                ...
                char Nombres = ke.getKeyChar();
               if (((Nombres < 'a' | Nombres > 'z') & (Nombres < 'A' | Nombres > 'Z') & (Nombres != KeyEvent.VK_SPACE)) | (vista.getTxtApellidos().getText().length() >= 50)) {
                    ke.consume();
                }
    ...
    KeyListener knna = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
                ...
                char Nombres = ke.getKeyChar();
               if (((Nombres < 'a' | Nombres > 'z') & (Nombres < 'A' | Nombres > 'Z') & (Nombres != KeyEvent.VK_SPACE)) | (vista.getTxtNombres_act().getText().length() >= 50)) {
                    ke.consume();
                }
    ...
    KeyListener kana = new KeyListener() {
            ...
            public void keyTyped(KeyEvent ke) {
                ...
                char Nombres = ke.getKeyChar();
               if (((Nombres < 'a' | Nombres > 'z') & (Nombres < 'A' | Nombres > 'Z') & (Nombres != KeyEvent.VK_SPACE)) | (vista.getTxtApellidos_act().getText().length() >= 50)) {
                    ke.consume();
                }
